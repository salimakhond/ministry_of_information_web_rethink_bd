...
const AboutUs = () => {
  return (
    <div>
      {" "}
      <div className="">
        <div className="flex items-center gap-16 max-w-full px-8 lg:p-0 my-12 lg:mt-24 lg:mb-32 flex-col lg:flex-row">
          <div className="w-full lg:w-6/12 relative ml-[60px] lg:ml-10 pr-5 lg:p-0">
            <img
            ...
            />
            <div className="bg-[#609513] border h-full w-full -z-10 absolute bottom-[-40px] left-[-40px]"></div>
          </div>
          <div className="w-full lg:w-6/12">
            ...
            <p className="text-lg mb-5 text-[#222]">
              Welcome to the Ministry of Information and Broadcasting of
              Bangladesh. We play a key role in bridging the government and
              citizens by providing clear, reliable information. The Ministry is
              dedicated to fostering national unity and progress by connecting
              people through information, culture, and digital initiatives.
              Explore our work as we continue to serve and inform the people of
              Bangladesh.
            </p>
